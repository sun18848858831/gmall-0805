...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4FsjTAEpBm6ZvdiSf5zi"; // 请填写您的AccessKeyId。
        String accessKey = "r7VxLhgUpUgY59qE8iVOQZS36BgZuY"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmallsyh"; // 请填写您的 bucketname 。
